...
import 'package:chatting/model/message_model.dart';
...
class _MessageListScreenState extends State<MessageListScreen> {
  ...
  Stream<List<MessageModel>> streamMessages() {
    try {
      ...
      final Stream<QuerySnapshot> snapshots = FirebaseFirestore.instance.collection('chatrooms/e1IX0v2WJ7f6k3W9iCUe/messages').snapshots();
      ...
      return snapshots.map((querySnapshot) {
        ...
        querySnapshot.docs.forEach((element) {
          ...
          messages.add(MessageModel.fromMap(id: element.id, map: element.data() as Map<String, dynamic>));
        });
